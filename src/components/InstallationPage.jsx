        ...
        <div className="h-[80%] text-gray-900">
            ...
            <section id="installationguide" className="py-16 px-10 max-w-4xl">
                ...
                <p className="mt-4 text-gray-700 leading-relaxed">
                    Follow these simple steps to install and configure the <strong>RoomCraft</strong> package in your project.
                </p>
            </section>
...
`}
            ...
            <section className="px-10 max-w-4xl  mb-8">
